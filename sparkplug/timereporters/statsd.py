...
class _Statsd(Base):
    ...
    def append_wait(self, delta, tags=None):
        ...
        tags = self.tags + (tags or [])
        self.statsd.timing('msg.wait', delta, tags=tags, rate=self.sample_rate)
