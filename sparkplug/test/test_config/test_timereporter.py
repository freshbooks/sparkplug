...
def test_no_statsdecor():
    ...
    s = Statsd()
    s.append_exec(123, tags=['doesnt:matter'])
    s.append_wait(124, tags=['doesnt:matter'])
    s.append_erro(125, tags=['doesnt:matter'])
